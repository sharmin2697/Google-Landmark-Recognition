...
class Ui_KNN(object):
    def setupUi(self, KNN):
        ...
        KNN.resize(1072, 937)
        self.groupBox = QtWidgets.QGroupBox(KNN)
        ...
        self.pushButton.clicked.connect(self.knn)
    ...
    def retranslateUi(self, KNN):
        ...
        KNN.setWindowTitle(_translate("KNN", "Landmark Recognition - KNN"))
        self.groupBox.setTitle(_translate("KNN", "Click to get Results"))
        self.pushButton.setText(_translate("KNN", "Result"))
        self.label.setText(_translate("KNN", ""))
        self.label_2.setText(_translate("KNN", ""))
        self.label_3.setText(_translate("KNN", ""))
        self.label_4.setText(_translate("KNN", ""))
        self.label_5.setText(_translate("KNN", ""))
    ...
    def knn(self):
        ...
        self.label.setText(" Model Evaluation Metrics - KNN ")
        self.label_2.setText("Accuracy Score : " + str(Accuracy_KNN))
        self.label_3.setText("Confusion Matrix" + str(df_cm_KNN))
        self.label_4.setText(" Classification Report \n" + str(classification_report(test_label_data, pred_KNN)))
        self.label_5.setText(" Cohen Kappa Score "+ str(cohen_KNN))
        Model_comp = Model_comp.append({"Model": "KNN", "Accuracy_Score": Accuracy_KNN, "Cohen Kappa Score": cohen_KNN},
                                       ignore_index=True)
